...
/***/ function(module, exports, __webpack_require__) {
	...
	var bucketList = __webpack_require__(8);
	var nav = __webpack_require__(32);
	var authUi = __webpack_require__(33);
	var viewstates = __webpack_require__(34);
	var fillGauge = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.signIn(data).done(ui.signInSuccess, fillGauge.fillGauge).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetTasks = function onGetTasks() {
	...
	var onCreateTask = function onCreateTask(event) {
		event.preventDefault();
		var data = getFormFields(event.target);
		api.createTask(data).done(ui.success).fail(ui.failure);
	};
	...
	var onDeleteTask = function onDeleteTask(event) {
		...
		api.deleteTask(taskId).done(onGetTasks).fail(ui.failure);
	};

	var onUpdateTask = function onUpdateTask() {
		var taskId = $(this).attr('-data-id');

		api.updateTask(taskId).done(onGetTasks).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showTasksTemplate = __webpack_require__(11);
	...
	var getTaskSuccess = function getTaskSuccess(data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <tr>\n    <td>"
	    ...
	    + "</td>\n    <td><button id=\"delete\" -data-id= tasks._id> delete</button></td>\n    <td><button id=\"update\" -data-id= tasks._id>update</button></td>\n  </tr>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var userage = function userage() {
	    return new Date().getFullYear() - app.user.yearOfBirth;
	};

	var fillGauge = function fillGauge() {

	    var calculate = function calculate() {
	        var thisYear = new Date().getFullYear();
	        var age = thisYear - app.user.yearOfBirth;
	        var percentage = 100 - age / 80 * 100;
	        return percentage;
	    };
	    ...
	    var gauge2 = loadLiquidFillGauge("fillgauge2", calculate(), config1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var navFunction = function navFunction() {
	  ...
	  $('#menu-toggle').on('click', function () {
	    ...
	    if (!active4) $(this).find('.mask2').css({ 'transform': 'rotate(-90deg)' });else $(this).find('.mask2').css({ 'transform': 'none' });
	    if (!active1) $(this).find('.home-menu-btn').css({ 'transform': 'translate(0px,125px)' });else $(this).find('.home-menu-btn').css({ 'transform': 'none' });
	    if (!active2) $(this).find('.auth-menu-btn').css({ 'transform': 'translate(50px,105px)' });else $(this).find('.auth-menu-btn').css({ 'transform': 'none' });
	    if (!active3) $(this).find('.stats-menu-btn').css({ 'transform': 'translate(95px,60px)' });else $(this).find('.stats-menu-btn').css({ 'transform': 'none' });
	    if (!active4) $(this).find('.bucketlist-menu-btn').css({ 'transform': 'translate(115px,0px)' });else $(this).find('.bucketlist-menu-btn').css({ 'transform': 'none' });
	    active1 = !active1;
	    active2 = !active2;
	    active3 = !active3;
	    active4 = !active4;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "f59d9df7fe688e2d34981b0ebfe313dc.jpg";

/***/ },
/* 44 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "4b50dd5bb82b96aa940a67e9b9d0b7c6.jpg";

/***/ },
/* 45 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "a8fe2ad44b9a6a55469318ffdeadcbee.jpg";

/***/ },
/* 46 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "252b58e4aeaa5e272370340c714dfa8f.jpg";
